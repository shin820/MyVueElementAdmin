  ...
  <div v-if="!item.hidden&&item.children" class="menu-wrapper">
      ...
      <el-submenu v-else :index="item.name||item.path">
        ...
        <template v-for="child in item.children" v-if="!child.hidden">
          <nav-menu-item :is-nest="true" class="nest-menu" v-if="child.children&&child.children.length>0" :item="child" :key="child.path" :base-path="resolvePath(child.path)"></nav-menu-item>
