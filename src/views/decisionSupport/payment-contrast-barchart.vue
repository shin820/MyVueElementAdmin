    ...
    <el-row :gutter="32">
      <el-col :xs="24" :sm="24" :lg="24">
        <div class="chart-wrapper">
          <chart title="计量支付情况" ref="chart" :onclick="handleBarChartClick" height="calc(100vh - 230px)"></chart>
        </div>
      </el-col>
    </el-row>
  </div>
...
import { getAmountContrast } from '@/api/contract'
...
export default {
  ...
  methods: {
    ...
    loadData() {
      ...
      getAmountContrast(this.query).then(res => {
