    ...
    <el-row :gutter="32">
      <el-col :xs="24" :sm="24" :lg="24">
        <div class="chart-wrapper">
          <chart :showPercent=true title="变更原因分析" ref="chart" :onclick="handleBarChartClick" height="calc(100vh - 230px)"></chart>
        </div>
      </el-col>
    </el-row>
  </div>
...
import { getReasonAmounts } from '@/api/alteration'
...
export default {
  ...
  methods: {
    ...
    handleBarChartClick(params) {
      ...
      query.type2Id = this.chartData.ids[index]
    ...
    loadData() {
      ...
      getReasonAmounts(this.query).then(res => {
