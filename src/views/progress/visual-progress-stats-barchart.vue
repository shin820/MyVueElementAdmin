    ...
    <el-row :gutter="32">
      <el-col :xs="24" :sm="24" :lg="24">
        <div class="chart-wrapper">
          <chart title="项目形象进度情况" ref="chart" :onclick="handleBarChartClick" height="calc(100vh - 230px)"></chart>
        </div>
      </el-col>
    </el-row>
  </div>
...
import { getVisualProgressStats } from '@/api/progress'
...
export default {
  ...
  methods: {
    ...
    loadData() {
      ...
      getVisualProgressStats(this.query).then(res => {
