    ...
    <el-row :gutter="32">
      <el-col :xs="24" :sm="24" :lg="24">
        <div class="chart-wrapper">
          <chart title="已完成投资占比" ref="chart" :onclick="handleChartClick" height="calc(100vh - 230px)"></chart>
        </div>
      </el-col>
    </el-row>
  </div>
...
export default {
  ...
  methods: {
    ...
    loadData() {
      ...
      getCompanyCompleteStats(this.query).then(res => {
